...
c      double precision   norm_temp1(2), norm_temp2(2)
      double precision, dimension(2), save :: norm_temp1
      double precision, dimension(2), save :: norm_temp2
...
c---------------------------------------------------------------------
     ...
     &         shift .eq. 500.d0 ) then
      ...
      if( me .eq. root )then
         ...
         write( *,1004 ) nonzer
         write( *,1005 ) shift
 1000 format(//,' NAS Parallel Benchmarks 3.2 -- CG Benchmark', /)
